...
void hash(int text_length, BYTE* text_input, BYTE result[32]) {
#pragma HLS INTERFACE m_axi depth=256 port=text_input
...
void printSha(unsigned char sha[32]) {
	int i;
	for (i = 0; i < 32; i++)
	{
	    printf("%02X", sha[i]);
